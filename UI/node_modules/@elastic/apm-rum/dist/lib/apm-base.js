...
var ApmBase = function () {
  ...
  _proto.init = function init(config) {
    ...
    if (this.isEnabled() && !this._initialized) {
      ...
      if (isConfigActive) {
        ...
        var performanceMonitoring = this.serviceFactory.getService(_apmRumCore.PERFORMANCE_MONITORING);
        performanceMonitoring.init(flags);

        if (flags[_apmRumCore.ERROR]) {
          var errorLogging = this.serviceFactory.getService(_apmRumCore.ERROR_LOGGING);
        ...
        if (flags[_apmRumCore.EVENT_TARGET] && flags[_apmRumCore.CLICK]) {
          (0, _apmRumCore.observePageClicks)(transactionService);
        }
      } else {
        this._disable = true;
  ...
  _proto.config = function config(_config) {
    var _this$serviceFactory$3 = this.serviceFactory.getService([_apmRumCore.CONFIG_SERVICE, _apmRumCore.LOGGING_SERVICE]),
